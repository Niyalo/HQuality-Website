  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {clients.map((clientItem) => ( // Renamed 'client' to 'clientItem' to avoid conflict with `client` object
          <div
            key={clientItem._id}
          ...
          >
            <div className="relative w-32 h-32 mb-4 rounded-full overflow-hidden border-4 border-blue-200">
              <Image
                src={clientItem.user_img?.asset?.url || '/images/default-avatar.png'} // Fallback image
